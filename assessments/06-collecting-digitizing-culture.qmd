...
1. **Finding the African American Periodical Poetry**: Using the Hennessey dataset from your readings, select 2-3 poems from different magazines (e.g., *The Crisis*, *Opportunity*, *Black Opals*). Try to locate the original magazine issues in HathiTrust that contain these poems.
