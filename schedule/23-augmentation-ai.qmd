...
- [ ] Discuss the assigned readings. Slides available [here](../slides/16-augmentation-ai.qmd){target="_blank"}
- [ ] Presentations from the final group work assignment [Critical Computing & Cultural Data](../assessments/07-critical-computing-cultural-data.qmd)
