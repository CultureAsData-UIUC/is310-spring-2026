...
- [ ] Start [Introduction to the Command Line & Prompt Engineering](../materials/introducing-humanities-computing/02-intro-cli-prompt-engineering.qmd) and [Introduction to Versioning & Git](../materials/introducing-humanities-computing/03-intro-versioning.qmd)(if not completed in-class, these will become homework).
