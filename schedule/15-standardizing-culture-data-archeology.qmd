...
- [ ] Complete remainder of the [Introduction to Web Scraping](../slides/10-web-scraping.qmd#full-web-scraping-example){target="_blank"}. Code from Thursday available <a href="../assets/files/first_web_scraping.py" download>here</a>.
- [ ] Discuss assigned readings. Slides available [here](../slides/11-standardizing-culture.qmd){target="_blank"}
...
- The *Newspaper Navigator Project* [https://news-navigator.labs.loc.gov/](https://news-navigator.labs.loc.gov/).
...
- Ben Lee's video demoing the site that used to exist [https://labs.loc.gov/static/labs/images/NN-demo.mp4](https://labs.loc.gov/static/labs/images/NN-demo.mp4)
