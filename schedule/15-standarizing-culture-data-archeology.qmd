...
- [ ] Discuss and demo the remainder of the [Advanced Web Scraping Section](../materials/creating-curating-humanities-data/05-web-scraping.qmd#advanced-web-scraping). You are welcome to read this material prior to class but it is not required.
- [ ] Discuss assigned readings
- [ ] Time permitting: Group presentations for the [Proprietary & Perspectival Data Creation Assignment](../proprietary-perspectival-dataset-creation.qmd). These may get moved to the next class on Thursday if we run out of time.
...
- [ ] [Proprietary & Perspectival Data Creation Assignment](../proprietary-perspectival-dataset-creation.qmd)
...
- [ ] [Critical Cultural Data Explorations](../critical-cultural-data-explorations.qmd)
