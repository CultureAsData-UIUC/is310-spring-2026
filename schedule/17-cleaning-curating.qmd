...
- [ ] Review the [Fandom Wikis and Web Scraping Homework](../materials/creating-curating-humanities-data/05-web-scraping.qmd#fandom-wikis-and-web-scraping-homework){target="_blank"}.
- [ ] Finish the remainder of [introduction to APIs and cultural data](../slides/12-cultural-apis.qmd#nrh-lotr-structure){target="_blank"}.
