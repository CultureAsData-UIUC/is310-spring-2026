...
::: {.r-fit-text}
In your `first_web_scraping.py` file, try to modify the code so that it only prints the titles of the `Top 100 EBooks yesterday` section.

To do this, you'll need to:

1. Access the correct tag for `Top 100 EBooks yesterday`
2. Use `BeautifulSoup` to navigate to the correct `ol` tag
3. Print just the title of each book
