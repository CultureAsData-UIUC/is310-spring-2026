...
- **Ted Nelson's *Project Xanadu*** (1960s-70s) - create a system to link any information to any other
...
Ted Nelson developed Project Xanadu, which tried to create a system where you could link any piece of information to any other piece. It was very influential but never fully realized. You can read more at https://en.wikipedia.org/wiki/Project_Xanadu

Douglas Engelbart developed the first computer mouse and the first hypertext system.

But it was really Tim Berners-Lee working at CERN (the European Organization for Nuclear Research) in the 1980s and 1990s who developed the World Wide Web as we know it. He created three key components that made the modern web possible.
:::

## Tim Berners-Lee's Vision

![Tim Berners-Lee's initial vision for the web](https://www.w3.org/History/1989/Image1.gif)
...
You can read more about the web's history at https://worldwideweb.cern.ch/
:::
...
For a detailed timeline of internet and computing history from the 1960s-1990s, see the Computer History Museum's timeline: https://www.computerhistory.org/internethistory/
...
![URL Anatomy](https://developer.mozilla.org/en-US/docs/Learn/Common_questions/Web_mechanics/What_is_a_URL/mdn-url-all.png)

::: {.notes}
URLs are how we locate and access resources on the web. They're like postal addresses for the internet—you need them to "send a request" to a webpage.

You've already encountered URLs when we created an `<a>` tag in our HTML pages. For example:
