...
::: {.callout-note}
⚡️ As a reminder, this course assumes you have either taken a programming course or have some experience with programming. If you don't have any experience with programming, you should contact the instructor immediately.
:::
...
If you don't see these messages, then you might not have Python installed, so return to our [setup instructions](../introducing-humanities-computing/01-course-tools/#python) and reach out to the instructors for assistance.
...
![Hello World](../../assets/images/python_hw.png)
...
![Assign Value to Variable](https://www.datamentor.io/sites/tutorial2program/files/assign-value-to-variable.png)
...
![Syntax Error](../../assets/images/syntax_error.png)
...
![Python Dictionary](https://www.udacity.com/blog/wp-content/uploads/2020/12/Screen-Shot-2020-12-01-at-9.08.23-AM.png)
