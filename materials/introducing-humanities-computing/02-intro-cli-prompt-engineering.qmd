...
![Example punch card from the Index Thomisticus, one of the first Computing in the Humanities projects started in the 1940s to digitize the writings of Thomas Aquinas](https://theoreti.ca/wp-content/uploads/2016/03/IMG_1628.jpg)
...
![GUI example](https://melaniewalsh.github.io/Intro-Cultural-Analytics/_images/GUI-example.gif)

![CLI example](https://melaniewalsh.github.io/Intro-Cultural-Analytics/_images/CLI-example.gif)
...
![Demo example](../../assets/images/demo_terminal.png)

If we press enter, it should seem like this works but how do we know for sure?

We have two options. First, we should take a look at the [Command Line cheatsheet](../introducing-humanities-computing/04-command-line-cheatsheet) that contains a number of these commands and see what would be the best option to help us check if this worked.
...
![GPT-3 example](https://github.com/Mooler0410/LLMsPracticalGuide/raw/main/imgs/tree.jpg)
...
![4S of Prompt Engineering](../../assets/images/4s_copilot.png)
...
![Prompt Engineering](https://learn.microsoft.com/en-us/training/github/introduction-prompt-engineering-with-github-copilot/media/3-prompt-processing-flow-diagram.png)
...
So returning to our original question, hopefully by now we have discovered some of the commands we can use to check if our directory was created, using the [Command Line cheatsheet](../introducing-humanities-computing/04-command-line-cheatsheet). But we could also try out generating a prompt for GitHub Co-Pilot and see what it suggests.
...
![Current Directory](https://heardlibrary.github.io/digital-scholarship/computer/images-2-pc/file-tree.png)
