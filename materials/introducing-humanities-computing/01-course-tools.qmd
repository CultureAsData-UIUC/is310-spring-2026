...
![Our Slack Channel on DH@UIUC Slack Team](../../assets/images/dh_slack.png)
...
![Hypothesis Chrome Extension](https://d242fdlp0qlcia.cloudfront.net/uploads/2018/03/05081258/kb_chrome_web_store-1200x375.png)
...
![Hypothesis Chrome Extension](https://d242fdlp0qlcia.cloudfront.net/uploads/2019/01/23170325/ActivatingChrome.png)

Or if you are in Firefox or Safari, you should activate the bookmarklet by clicking the bookmarklet in your bookmarks bar.

![Hypothesis Firefox Extension](https://d242fdlp0qlcia.cloudfront.net/uploads/2019/01/23170513/ActivatingFirefox.png)
...
![Hypothesis Sidebar](https://d242fdlp0qlcia.cloudfront.net/uploads/2019/01/23170615/OpeningSidebar.png)

You'll want to make sure that you are logged into your account, which you can do in the sidebar:

![Hypothesis Signing In](https://d242fdlp0qlcia.cloudfront.net/uploads/2019/01/23170903/SigningIn.png)

Finally, you can start annotating by selecting text on a webpage and clicking the "Annotate" button that appears.

![Hypothesis Adding Annotations](https://d242fdlp0qlcia.cloudfront.net/uploads/2019/01/23190551/AddingAnnotations.jpg)
...
![Hypothesis Annotation](https://d242fdlp0qlcia.cloudfront.net/uploads/2018/03/21135305/scopeselector-groupname-1024x585.png)
...
![Hypothesis Extension Icon](https://d242fdlp0qlcia.cloudfront.net/uploads/2018/03/20121745/Screen-Shot-2020-03-20-at-3.14.12-PM.png)

- Then, dismiss the pop-up window that appears.

![Hypothesis Extension Options](https://d242fdlp0qlcia.cloudfront.net/uploads/2018/03/20121814/Screen-Shot-2020-03-20-at-3.15.21-PM.png)

- Finally, make sure site access is set to “On all sites” and switch the control on for “Allow access to file URLs”

![Hypothesis Extension Options](https://d242fdlp0qlcia.cloudfront.net/uploads/2018/03/20115610/allow-access-file-urls-1024x955-1.png)
...
![Digital Humanities Repositories on GitHub](../../assets/images/dh_github_popularity.png)
...
![Visual Studio Code](https://static.thechief.io/prod/images/IDE.width-1024.format-webp-lossless.webp)
...
![Disable GitHub Copilot](../../assets/images/vscode_disable_copilot.png)
...
![Enable GitHub Copilot](../../assets/images/vscode_enable_copilot.png)
...
![Python Definition](../../assets/images/python_def.png)
...
<table>
  <tr>
    <td>
      ![python twitter](../../assets/images/python_twitter.png)

*Jake VanderPlas Tweet*
    </td>
    <td>
      ![python stack overflow](../../assets/images/python_so.png)
...
![VS Code Terminal](../../assets/images/vscode_terminal.png)
...
![oh-my-posh](https://zimmergren.net/content/images/2021/03/terminal-oh-alien.png)
...
![Git Definition](https://www.nobledesktop.com/image/blog/git-branches-merge.png)
